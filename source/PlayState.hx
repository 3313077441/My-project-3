...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
			...
			case 'eddhouse':
				{
						defaultCamZoom = 0.9;
						curStage = 'eddhouse';
						var bg:FlxSprite = new FlxSprite(-400, -300).loadGraphic(Paths.image('bg1'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
			...
			case 'house':
				{
						defaultCamZoom = 0.9;
						curStage = 'house';
						var bg:FlxSprite = new FlxSprite(-400, -300).loadGraphic(Paths.image('bg2'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - Port by HeHe be KE " + MainMenuState.kadeEngineVer : ""), 16);
	...
	function startSong():Void
	{
		...
		DiscordClient.changePresence(detailsText + " " + SONG.song + " (" + storyDifficultyText + ") " + Ratings.GenerateLetterRank(accuracy), "\nAcc: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Score: " + songScore + " | Port by HeHe be | Misses: " + misses  , iconRPC);
		#end
	}
