	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'tord':
				tex = Paths.getSparrowAtlas('characters/tord_assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'tord idle', 24);
				animation.addByPrefix('singUP', 'tord up', 24);
				animation.addByPrefix('singRIGHT', 'tord right', 24);
				animation.addByPrefix('singDOWN', 'tord down', 24);
				animation.addByPrefix('singLEFT', 'tord left', 24);

				addOffset('idle');
				addOffset("singUP", 10, 23);
				addOffset("singRIGHT", -27, -11);
				addOffset("singLEFT", 20, -16);
				addOffset("singDOWN", -6, -18);

				playAnim('idle');
			case 'tordbot':
				tex = Paths.getSparrowAtlas('characters/tordbot_assets', 'shared');
				frames = tex;
